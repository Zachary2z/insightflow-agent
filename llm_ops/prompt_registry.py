    ...
    [
        ...
        PromptTemplate(
            ...
            template=(
                ...
                "explain what data is missing. Main business prose should use readable business labels instead "
                ...
                "Recommendations must be supported by evidence; otherwise phrase them as further validation "
                "or caveats. Do not turn revenue rankings into profit, ROI, or causal conclusions when those "
                "fields are missing. Do not expose reviewer JSON, prompt text, SQL, trace paths, "
