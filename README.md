...
| P27 Analysis Workbench multi-agent refactor | In progress | H1-H2 complete: contracts, Report Center boundary tests, Coordinator, and Data Understanding surface; `docs/product/plans/2026-07-04-p27-analysis-workbench-multi-agent-refactor.md` |
